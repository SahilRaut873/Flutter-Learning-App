...
class QuickTestSceen extends StatefulWidget {
  final int initialQuestionIndex;

  const QuickTestSceen({Key? key, this.initialQuestionIndex = 0}) : super(key: key);

  @override
  _QuickTestSceenState createState() => _QuickTestSceenState();
}
...
class _QuickTestSceenState extends State<QuickTestSceen> {
      ...
      if (questionIndex == questionList.length - 1) {
        ...
        Navigator.push(
          ...
          PageTransition(
            ...
            child: QuickTestSceen(initialQuestionIndex: questionIndex + 1),
          ),
        ).then((_) {
          setState(() {
            questionIndex++;
