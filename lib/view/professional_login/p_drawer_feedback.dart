...
class ProfFeedBackForm extends StatefulWidget {
  const ProfFeedBackForm({super.key});

  @override
  State<ProfFeedBackForm> createState() => _ProfFeedBackFormState();
}

class _ProfFeedBackFormState extends State<ProfFeedBackForm> {
  double rating = 0.0;
  @override
  Widget build(BuildContext context) {
    ...
    onPressed: (){Navigator.of(context).pushReplacement(MaterialPageRoute(builder: ((context)=>ProfBottomBar())));
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              "        Send us your feedback\nDo you have a ProfFeedBackForm let us\n         know in the field bellow",
                              style: TextStyle(
                                  fontSize: 15,
