...
class ProfTakeQuiz extends StatefulWidget {
  final int initialQuestionIndex;

  const ProfTakeQuiz({Key? key, this.initialQuestionIndex = 0}) : super(key: key);
...
class _TakeQuizScreenState extends State<ProfTakeQuiz> {
      ...
      if (questionIndex == questionList.length - 1) {
        ...
        Navigator.push(
          ...
          PageTransition(
            ...
            child: ProfTakeQuiz(initialQuestionIndex: questionIndex + 1),
          ),
        ).then((_) {
          setState(() {
            questionIndex++;
