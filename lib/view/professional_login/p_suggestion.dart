...
class ProfSuggestion   extends StatefulWidget {
  const ProfSuggestion  ({super.key});

  @override
  State<ProfSuggestion> createState() => _ProfSuggestionState();
}

class _ProfSuggestionState extends State<ProfSuggestion  > {
  double rating = 0.0;
  @override
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              "        Send us your feedback\nDo you have a ProfSuggestion   let us\n         know in the field bellow",
                              style: TextStyle(
                                  fontSize: 15,
