...
class ProfDrawerQuizScreen  extends StatefulWidget {
  final int initialQuestionIndex;

  const ProfDrawerQuizScreen ({Key? key, this.initialQuestionIndex = 0}) : super(key: key);
...
class _TakeQuizScreenState extends State<ProfDrawerQuizScreen > {
      ...
      if (questionIndex == questionList.length - 1) {
        ...
        Navigator.push(
          ...
          PageTransition(
            ...
            child: ProfDrawerQuizScreen (initialQuestionIndex: questionIndex + 1),
          ),
        ).then((_) {
          setState(() {
            questionIndex++;
                    ...
                    leading: IconButton.outlined(
                        ...
                        onPressed: () {
                          Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                  builder: ((context) => ProfQuestionBankList())));
