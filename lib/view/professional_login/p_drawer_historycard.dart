...
class ProfDrawerHistoryCard extends StatefulWidget {
  const ProfDrawerHistoryCard({super.key});

  @override
  State<ProfDrawerHistoryCard> createState() => _ProfDrawerHistoryCardState();
}

class _ProfDrawerHistoryCardState extends State<ProfDrawerHistoryCard> {
  @override
