...
class ProfHomeNotification extends StatefulWidget {
  const ProfHomeNotification({super.key});

  @override
  State<ProfHomeNotification> createState() => _DemoNotificationState();
}

class _DemoNotificationState extends State<ProfHomeNotification> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        // decoration: BoxDecoration(
        //   image: DecorationImage(image: AssetImage("assets/Asset 6@2x.png"),fit: BoxFit.cover)
        // ),
