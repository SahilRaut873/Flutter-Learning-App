...
class QuizApp2 extends StatefulWidget {
  ...
  const QuizApp2({Key? key, this.initialQuestionIndex = 0}) : super(key: key);
      ...
      if (questionIndex == questionList.length - 1) {
        ...
        Navigator.push(
          ...
          PageTransition(
            ...
            child: QuizApp2(initialQuestionIndex: questionIndex + 1),
          ),
        ).then((_) {
          setState(() {
            questionIndex++;
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 25.0, vertical: 50).copyWith(bottom: 150),
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            padding: const EdgeInsets.symmetric(vertical: 15, horizontal: 8), // Reduced vertical padding
                            decoration: BoxDecoration(
        ...
        body: Stack(
          children: [
            Container(
              ...
              width: double.infinity,
              decoration: BoxDecoration(
                image: DecorationImage(image: AssetImage("assets/images/bg2.jpeg"), fit: BoxFit.cover),
              ),
            ),
            Column(
              children: [
            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all<Color>(Color.fromRGBO(220, 103, 39, 1)),
                    ...
                    // Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Demo()));// Example action
                    },
                    child: const Text(
                      "Finish",
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: isChecked ? Colors.white : const Color.fromARGB(0, 255, 255, 255),
      ),
      child: isChecked
          ? Icon(
