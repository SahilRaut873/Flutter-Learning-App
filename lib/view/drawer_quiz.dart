...
class DrawerQuizScreen extends StatefulWidget {
  final int initialQuestionIndex;

  const DrawerQuizScreen({Key? key, this.initialQuestionIndex = 0}) : super(key: key);
...
class _TakeQuizScreenState extends State<DrawerQuizScreen> {
      ...
      if (questionIndex == questionList.length - 1) {
        ...
        Navigator.push(
          ...
          PageTransition(
            ...
            child: DrawerQuizScreen(initialQuestionIndex: questionIndex + 1),
          ),
        ).then((_) {
          setState(() {
            questionIndex++;
                    ...
                    leading: IconButton.outlined(
                        ...
                        onPressed: () {
                          Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                  builder: ((context) => QuestionBankList())));
      ...
      return Scaffold(
        body: Stack(
          children: [
            ...
            Column(
              children: [
                Padding(padding: EdgeInsets.only(top: 90,left: 30)),
                Row(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: ((context) => QuestionBankList())));
                Navigator.pop(context);
              }),
              SizedBox(
                width: 66,
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.pushReplacement(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  ProfQuestionBankList())); // Example action
                    },
                    style: ButtonStyle(
